...
/////////////////////////
FileOperation(FileOperation npd)
{
this.npd=npd;
...
/************************************/
public class FileOperation  implements ActionListener, MenuConstants
{
...
JOptionPane.showMessageDialog(FileOperation.this.f,
...
{
if(FileOperation.this.ta.getText().length()==0)
	return;	// text box have no text
if(findReplaceDialog==null)
	findReplaceDialog=new FindDialog(FileOperation.this.ta);
findReplaceDialog.showDialog(FileOperation.this.f,true);//find
}
////////////////////////////////////
...
if(findReplaceDialog==null)
	findReplaceDialog=new FindDialog(FileOperation.this.ta);
findReplaceDialog.showDialog(FileOperation.this.f,false);//replace
}
////////////////////////////////////
...
if(fontDialog.showDialog(FileOperation.this.f,"Choose a font"))
	FileOperation.this.ta.setFont(fontDialog.createFont());
}
////////////////////////////////////
...
{
JOptionPane.showMessageDialog(FileOperation.this.f,aboutText,"Dedicated 2 u!",JOptionPane.INFORMATION_MESSAGE);
}
else
...
if(backgroundDialog==null)
	backgroundDialog=JColorChooser.createDialog
		(FileOperation.this.f,
		formatBackground,
		false,
		bcolorChooser,
		new ActionListener()
		{public void actionPerformed(ActionEvent evvv){
			FileOperation.this.ta.setBackground(bcolorChooser.getColor());}},
		null);		
...
if(foregroundDialog==null)
	foregroundDialog=JColorChooser.createDialog
		...
		new ActionListener()
		{public void actionPerformed(ActionEvent evvv){
			FileOperation.this.ta.setForeground(fcolorChooser.getColor());}},
		null);		
...
MenuListener editMenuListener=new MenuListener()
{
   public void menuSelected(MenuEvent evvvv)
	...
	if(FileOperation.this.ta.getSelectionStart()==ta.getSelectionEnd())
	{
